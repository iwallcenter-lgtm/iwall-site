    ...
    <>
      ...
      <section className="py-20">
        <Container className="grid gap-6 lg:grid-cols-3">
          {messages.references.items.map((item, index) => (
            <div key={item} className="overflow-hidden rounded-[1.75rem] border border-black/10 bg-white shadow-sm">
              <MediaPlaceholder label={`Reference ${index + 1}`} className="h-60" />
              <div className="p-6">
