...
export async function generateMetadata({ params }: { params: Promise<{ locale: Locale }> }): Promise<Metadata> {
  ...
  return createPageMetadata(locale, messages.legal.shippingTitle, messages.legal.shippingText, "shipping-information");
}
...
export default async function ShippingInfoPage({ params }: { params: Promise<{ locale: Locale }> }) {
  ...
  return (
    <>
      <PageHero title={messages.legal.shippingTitle} description={messages.legal.shippingText} />
