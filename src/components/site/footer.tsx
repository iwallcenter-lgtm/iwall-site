    ...
    <footer className="border-t border-white/10 bg-green-luxury py-14 text-white">
      <Container className="grid gap-12 lg:grid-cols-[1.2fr_0.8fr_0.8fr_1fr]">
        <div className="space-y-5">
          ...
          <p className="max-w-sm text-sm leading-7 text-white/72">{messages.brand.tagline}</p>
        </div>
        <div>
          <h3 className="text-sm font-semibold uppercase tracking-[0.24em] text-gold">{messages.footer.quickLinks}</h3>
          <div className="mt-5 flex flex-col gap-3 text-sm text-white/84">
      ...
      <Container className="mt-10 border-t border-white/10 pt-6 text-sm text-white/56">
