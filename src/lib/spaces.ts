...
export const spaceCopy = {
  ...
  roomCatalog: label("i-WALL LAMBİRİ MEKAN KATALOĞU 2026", "i-WALL Wall Panelling Interior Catalog 2026", "i-WALL Wandpaneele Raumkatalog 2026", "Catalogue d’intérieurs en lambris i-WALL 2026", "كتالوج مساحات ألواح الجدران i-WALL 2026"),
  sectorCatalog: label("i-WALL LAMBİRİ SEKTÖREL MEKAN KATALOĞU 2026", "i-WALL Wall Panelling Sector Interiors Catalog 2026", "i-WALL Wandpaneele Branchen-Raumkatalog 2026", "Catalogue d’intérieurs par secteur en lambris i-WALL 2026", "كتالوج مساحات القطاعات بألواح الجدران i-WALL 2026"),
